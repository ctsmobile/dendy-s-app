                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          GestureDetector(
                                                                            ...
                                                                            onTap:
                                                                                () {
                                                                              launchURL(Uri.parse('https://www.google.com/maps/search/?api=1&query=${controller.activeJobModel.value.data.first.customer.lat.toString()},${controller.activeJobModel.value.data.first.customer.lng.toString()}'));
                                                                            },
                                                                          ),
                                                                        ],
                                                                      ),
