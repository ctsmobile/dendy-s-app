        ...
        child: Column(
          ...
          children: [
           if (!controller.showImage.value)
            Container( height: 200, child: Center(child: Loader(color: purpleColor,))), // Loader displayed for 2 seconds
          if (controller.showImage.value)
            Image.asset(
            ...
            Container( height: 200, child: Center(child: SizedBox())): Container(
                        width: 240,
                        height: 60,
